...
imgElon = face_recognition.load_image_file('your image')
imgElon = cv2.cvtColor(imgElon,cv2.COLOR_BGR2RGB)
imgTest = face_recognition.load_image_file('second image')
...
cv2.imshow('name1', imgElon)
cv2.imshow('name2', imgTest)
cv2.waitKey(0)
